...
const GROUP_VOICE_CALL_CONFIG = {
  ...
  bottomMenuBarConfig: {
    buttons: [ZegoMenuBarButtonName.hangUpButton, ZegoMenuBarButtonName.toggleMicrophoneButton, ZegoMenuBarButtonName.switchAudioOutputButton]
  },
  topMenuBarConfig: {
    buttons: [ZegoMenuBarButtonName.showMemberListButton]
  },
...
export { ZegoMenuBarButtonName, ZegoMenuBarStyle, ONE_ON_ONE_VIDEO_CALL_CONFIG, ONE_ON_ONE_VOICE_CALL_CONFIG, GROUP_VIDEO_CALL_CONFIG, GROUP_VOICE_CALL_CONFIG };
